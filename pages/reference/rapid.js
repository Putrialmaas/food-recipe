...
import pic from "../../public/assets/2.png";

export default function Reference() {
  return (
    <div>
      <Meta title="Food Recipe: Reference - Rapid API" />
      <Header />
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div class="text-center lg:w-2/3 w-full">
            ...
            <p class="mb-8 leading-relaxed">The world's largest API hub, is used by over three million developers to find, test, and connect to thousands of APIs — all with a single API key and dashboard.</p>
