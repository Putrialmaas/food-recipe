    ...
    <div>
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-10 mx-auto">
          <h1 class="text-3xl font-semibold title-font text-gray-900 mb-12 text-center">Frequently Asked Question</h1>
          <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/2 w-full">
              <div class="h-full bg-pink-100 p-8 rounded drop-shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="block w-5 h-5 text-pink-400 mb-4" viewBox="0 0 975.036 975.036">
                ...
                <p class="leading-relaxed mb-6 font-semibold">Apa kegunaan dari aplikasi Food Recipe?</p>
            ...
            <div class="p-4 md:w-1/2 w-full">
              <div class="h-full bg-pink-100 p-8 rounded drop-shadow-md">
                ...
                <p class="leading-relaxed mb-6 font-semibold">Fitur apa saja yang terdapat pada aplikasi food recipe ini?</p>
                <p class="leading-relaxed mb-6"></p>
